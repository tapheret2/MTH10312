...
-- Off checking referential constraints on phongban
ALTER TABLE phongban DISABLE TRIGGER ALL;
...
-- On checking referential constraint on phongban
ALTER TABLE phongban ENABLE TRIGGER ALL;

-- Off checking referential constraints on phongban
ALTER TABLE nhanvien DISABLE TRIGGER ALL;
